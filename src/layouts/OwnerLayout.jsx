    ...
    <div className="min-h-screen bg-gray-100 flex">
      <aside className="w-56 bg-white border-r border-gray-200 shadow-sm flex flex-col">
        <div className="p-4 border-b border-gray-200">
          <h3 className="font-bold text-gray-900">Restaurant Owner</h3>
        </div>
        ...
        <div className="p-3 border-t border-gray-200 space-y-1">
          ...
          <button
            ...
            className="w-full px-3 py-2 rounded-lg text-red-600 hover:bg-red-50 font-medium transition text-left"
          >
            Logout
          </button>
        </div>
